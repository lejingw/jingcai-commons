...
public class ParameterizedTests {
	private Logger logger = LoggerFactory.getLogger(ParameterizedTests.class);
	...
	public ParameterizedTests(int id, String username) {
		this.idParam = id;
	...
	public void testFindByName() {
		//System.out.println(usernameParam + "-------1------" + idParam);
		logger.debug("{}---------{}",usernameParam, idParam);
	}

	// (5)步骤五：编写测试方法，使用定义的变量作为参数进行测试。
	@Test
	public void testFindById() {
		//System.out.println(usernameParam + "-------2------" + idParam);
		logger.debug("{}---------{}",usernameParam, idParam);
	}
}  